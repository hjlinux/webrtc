    ...
    const VideoCaptureCapability& capability)
{
    ...
    _captureDelay = 120;
   printf("get : _currentWidth:%d,_currentHeight:%d,_captureVideoType:%d\n",_currentWidth,_currentHeight,_captureVideoType);
...
bool VideoCaptureModuleV4L2::CaptureProcess()
{
	...
	printf("_currentWidth:%d,_currentHeight:%d,_captureVideoType:%d\n",_currentWidth,_currentHeight,_captureVideoType);
...
if(fd == 0)
{
	fd =  open("/home/hejl/workspace/webrtc/webrtc-checkout/src/webrtc/modules/video_capture/linux_x86/video0.yuv",O_CREAT | O_TRUNC | O_RDWR,0666);
	write(fd,_pool[buf.index].start,buf.bytesused);
	printf("*************************************%d\n",_captureVideoType);
	exit(-1);
}
*/
